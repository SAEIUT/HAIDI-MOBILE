...
import { View, Text, StyleSheet, Image, ScrollView, Animated, Dimensions, TextInput, TouchableOpacity } from 'react-native';
      ...
      <ScrollView contentContainerStyle={styles.scrollContainer}>
        <View style={styles.container}>
          <AnimatedComponent.View entering={FadeInDown.duration(200).springify()} style={styles.logoContainer}>
            <Image source={require('../../assets/images/CMF_1.png')} style={styles.logo} />
